...
def get_house_info(url,session):
   ...
   try:
      house_info["latitude"] = properties["location"]["latitude"]
   except:
      house_info["latitude"] = 0
   try:
      house_info["longitude"] = properties["location"]["longitude"]
   except:
      house_info["longitude"] = 0
   try:
      house_info["street"] = script_text_dict["customers"][0]["location"]["street"]
   except:
      house_info["street"] = 0
   ...
   try:
      house_info['livable area']=properties["netHabitableSurface"]
   except:
      house_info["livable area"]= 0
